...
//     handleAddComment(replyComment, post.id, parentId, setErrors);
//     setReplying(false);
//     setReplyComment("")
// }
    ...
    return (
        <div style={{marginLeft: depth * 15}}>
            ...
            <article style={{marginLeft: depth * 15, padding: "12px", backgroundColor: 'lightgray', display: 'block', borderStyle: 'groove'}}>
            ...
            {/* {comment.replies && comment.replies.length > 0 && (<h2 style={{marginLeft: "10px"}}>Replies:</h2>)}
            <ul>
